...
macro ( _XMLTO_FILE outfiles mode)
  ...
  foreach ( dbFile ${ARGN} )
    ...
    if ( "${mode}" STREQUAL "man" )
      file ( READ "${dbFile}.in" _DB_FILE_CONTENTS )
    ...
    add_custom_command (
      ...
      COMMAND           ${XMLTO_EXECUTABLE} ${XMLTO_COMMAND_ARGS} -o ${dbFilePath}
                        ${XMLTO_MODE_${mode}} "${CMAKE_CURRENT_BINARY_DIR}/${dbFile}"
      COMMAND           ${GZIP} --keep --best ${dbFileAbsWE}.${XMLTO_FILEEXT_${mode}}
      BYPRODUCTS        ${dbFileAbsWE}.${XMLTO_FILEEXT_${mode}}.gz
      MAIN_DEPENDENCY   ${CMAKE_CURRENT_BINARY_DIR}/${dbFile}
